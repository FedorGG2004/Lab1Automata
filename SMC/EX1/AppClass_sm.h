...
public:
    ...
    virtual void One(AppClassContext& context);
    virtual void Unknown(AppClassContext& context);
    virtual void Zero(AppClassContext& context);
...
public:
    ...
    static Map1_Zeros Zeros;
    static Map1_Ones Ones;
    static Map1_OK OK;
...
{
public:
    Map1_Zeros(const char * const name, const int stateId)
    : Map1_Default(name, stateId)
    {};
...
{
public:
    Map1_Ones(const char * const name, const int stateId)
    : Map1_Default(name, stateId)
    {};
